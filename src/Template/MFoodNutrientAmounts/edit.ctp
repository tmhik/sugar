...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('削除'),
                ['action' => 'delete', $mFoodNutrientAmount->foodId],
                ['confirm' => __('Are you sure you want to delete # {0}?', $mFoodNutrientAmount->foodId)]
            )
        ?></li>
...
<div class="mFoodNutrientAmounts form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('編集 M Food Nutrient Amount') ?></legend>
        <?php
