...
?>
                <td class="actions">
                    <CakePHPBakeOpenTag= $this->Html->link(__('詳細'), ['action' => 'view', <?= $pk ?>]) CakePHPBakeCloseTag>
                    <CakePHPBakeOpenTag= $this->Html->link(__('編集'), ['action' => 'edit', <?= $pk ?>]) CakePHPBakeCloseTag>
                    <CakePHPBakeOpenTag= $this->Form->postLink(__('削除'), ['action' => 'delete', <?= $pk ?>], ['confirm' => __('Are you sure you want to delete # {0}?', <?= $pk ?>)]) CakePHPBakeCloseTag>
                </td>
            </tr>
    ...
    <div class="paginator">
        <ul class="pagination">
            ...
            <CakePHPBakeOpenTag= $this->Paginator->prev('< ' . __('前へ')) CakePHPBakeCloseTag>
            <CakePHPBakeOpenTag= $this->Paginator->numbers() CakePHPBakeCloseTag>
            <CakePHPBakeOpenTag= $this->Paginator->next(__('次へ') . ' >') CakePHPBakeCloseTag>
